...
### 密码库管理
- [x] **添加密码**: 加密存储网站/账号/密码/备注
- [x] **查看密码**: 解密并展示密码列表，支持备注列
- [x] **密码脱敏**: 默认显示 `********`
- [x] **一键复制**: 点击按钮复制账号、备注或明文密码到剪贴板
- [x] **复制反馈**: 按钮显示 "已复制!" 提示
- [x] **按用户隔离**: 每个用户数据独立加密
...
- [x] **时间戳文件名**: `key-box-backup-20260131-120530.db`
- [x] **一键恢复**: 从备份文件恢复数据
- [x] **覆盖警告**: 提示将覆盖当前数据
- [x] **自动备份**: 恢复前自动备份当前数据库
- [x] **原子操作**: 失败时自动回滚
...
### 文档
- [x] **设计文档**: 完整的架构说明 (674行)
- [x] **用户手册**: README.md / README.zh-CN.md 双语使用指南
- [x] **测试指南**: 备份恢复测试文档
- [x] **代码注释**: 详细的中文注释
- [x] **安全决策说明**: 每个关键点都有解释
